        ...
        {collapses.map((prop, key) => {
          return (
            ...
            >
              ...
              >
                <h4 className={classes.title} style={{color:"rgb(94, 71, 44)"}}>{prop.title}</h4>
              </ExpansionPanelSummary>
              <ExpansionPanelDetails className={classes.expansionPanelDetails} style={{color:"rgb(94, 71, 44)"}}>
                {prop.content}
