    ...
    const dropDownMenu = (
      <MenuList role="menu" className={classes.menuList}>
        {dropdownHeader !== undefined ? (
          <MenuItem
            onClick={() => {this.handleCloseMenu(dropdownHeader);this.handleClose()}}
        ...
        {dropdownList.map((prop, key) => {
          if (prop.divider) {
            return (
              <Divider
                key={key}
                onClick={() => {window.confirm('Clicked');this.handleCloseMenu("divider")}}
          ...
          return (
            <MenuItem
              key={key}
              onClick={() => {this.handleCloseMenu(prop);;this.handleCloseMenu("divider")}}
              className={dropdownItem}
            >
              {prop}
            </MenuItem>
