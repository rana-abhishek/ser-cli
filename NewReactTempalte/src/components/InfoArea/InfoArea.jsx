...
function InfoArea({ ...props }) {
  ...
  return (
    <div className={infoAreaClasses}>
      <div className={iconWrapper} style={{color:"rgb(94, 71, 44)"}}>{icon}</div>
      <div className={classes.descriptionWrapper}>
        <h4 className={classes.title} style={{color:"rgb(94, 71, 44)"}}>{title}</h4>
        <div className={classes.description} style={{color:"rgb(94, 71, 44)"}}>{description}</div>
      </div>
    </div>
  );
}
