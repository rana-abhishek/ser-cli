  ...
  return (
    ...
    >
      ...
      {props.data.galleryimages ? (
        <div>
          <h3 className={props.classes.title}>
            We perform following surgeries, among others, totally under local
            anaesthesia by the awake technique
          </h3>
          ...
          <h5 className={props.classes.title}>
            Augmentation (increasing the breast size by silicone implants, Gel
            filled & saline filled
          </h5>
          <div
            style={{
              display: "flex",
          ...
          <h5 className={props.classes.title}>
            Reduction –by the traditional methods or by liposuction in selected
            cases
          </h5>
          <div
            style={{
          ...
          <h4 className={props.classes.title}>
            4.Body Contouring Surgeries after excessive weight loss, sagging
            abdominal skin folds after deliveries or multiple abdominal
            surgeries. These are done on Abdomen, arms, thighs, hips and other
            parts
          </h4>
          <h5 className={props.classes.title}>
            A. Abdominoplasty (surgical tummy tuck) - total or limited
          </h5>
          <h5 className={props.classes.title}>B. Brachioplasty or arms-lift</h5>
          <h5 className={props.classes.title}>C. Thighplasty or thighs lift</h5>
          <h3 className={props.classes.title}>5. Other cosmetic surgeries</h3>
          <h5 className={props.classes.title}>
            Abdominoplasty (surgical tummy tuck) - total or limited
          </h5>
          <p className={props.classes.darkbrown}>
            Tumescent awake technique carries a very high safety profile.
            Patients can come, get the surgery done and go home immediately
            after surgery
          </p>
        </div>
      ) : null}
