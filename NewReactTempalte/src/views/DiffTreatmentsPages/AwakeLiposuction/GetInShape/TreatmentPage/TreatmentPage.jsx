...
// import image1 from "assets/img/TreatmentSections/AwakeLiposuction/GetInShape/GalleryImages/Image1.jpg";
// import image2 from "assets/img/TreatmentSections/AwakeLiposuction/GetInShape/GalleryImages/Image2.jpg";
// import image3 from "assets/img/TreatmentSections/AwakeLiposuction/GetInShape/GalleryImages/Image3.jpg";

import profilePic from "assets/img/TreatmentSections/AwakeLiposuction/GetInShape/RightProfileImage.png";
  ...
  render() {
    ...
    const treatdata = {
      main: {
        ...
        head2: "(Get in Shape by Liposuction)",
        desc: `Liposuction by the tumescent technique, totally under local anaesthesia where the patient is awake and conversing throughout the procedure, is unquestionably the safest method of doing body sculpting. More and more men and women are resorting to liposuction as the last resort to get rid of those obstinate, resistant fat deposits. Buns (outer thighs or side-bags), Bums (buttocks or hips) and Love-handles (Iliac rolls) are the prime figure destroyers.`
      },
      left: {
        // firsthead: "Get in Shape by Liposuction 'Buns, Bums & Love-hanldes'",
        // firstdesc: `Liposuction by the tumescent technique, totally under local anaesthesia where the patient is awake and conversing throughout the procedure, is unquestionably the safest method of doing body sculpting. More and more men and women are resorting to liposuction as the last resort to get rid of those obstinate, resistant fat deposits. Buns (outer thighs or side-bags), Bums (buttocks or hips) and Love-handles (Iliac rolls) are the prime figure destroyers.`,
    ...
    return (
      <div>
        ...
        />
        <Parallax
          image={require("assets/img/TreatmentSections/AwakeLiposuction/GetInShape/BG.jpg")}
          filter="dark"
