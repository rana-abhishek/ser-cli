    ...
    >
      ...
      {props.data.galleryimages ? (
        <div>
          ...
          <p className={props.classes.darkbrown}>
            There are different types of such surgeries. A bariatric surgery is
            primarily designed and performed to either reduce food intake or
            reduce nutritional absorption through the intestines. Accordingly
            they are called Restrictive and Mal-absorptive.
          </p>
          <div
            style={{
              display: "flex",
          ...
          <h5 className={props.classes.title}>
            Restrictive Bariatric surgeries are Adjustable Gastric banding and
            Sleeve gastrectomy.
          </h5>
          <h5 className={props.classes.title}>
            Malabsorptive surgeries are Roux-en-Y gastric bypass and
            Biliopancreatic diversion
          </h5>
          <p className={props.classes.darkbrown}>
            Massive weight loss leads to some very serious aesthetic or cosmetic
            problems for the patients. Most common aesthetic or cosmetic side
            effects of Massive weight loss after Bariatric surgery or otherwise
            is Folds & Folds of excessive skin all over the body. Quite often,
            psychologically they can be very disturbing.
          </p>
          <p className={props.classes.darkbrown}>
            Whenever there is massive weight loss, the skin and tissues under
            the skin, called sub-cutaneous tissues, undergo very significant
            deflation leading to collapse and sagging of skin. Loss of fat from
            intra-abdominal areas also adds very significantly to developing
            folds and folds of redundant skin. These are manifested as sagging
            skin folds on abdomen, thighs, hips, arms, chest, and neck. In fact,
            skin sags and folds of redundant skin develop all over the body.
            These are extremely difficult to treat with non-surgical methods due
            to serious loss of skin tone and its shrinking ability. Body
            Contouring Surgery is the only option.
          </p>
          <div
            style={{
              display: "flex",
