  ...
  return (
    ...
    >
      ...
      {props.data.galleryimages ? (
        <div>
          <h3 className={props.classes.title}>
            INFILTRATION OF TUMESCENT FLUID INTO THE AREA
          </h3>
      ...
      {props.data.galleryimages ? (
        <div>
          ...
          <p className={props.classes.darkbrown}>
            Patients are awake and conversant during the surgery. Most of the
            time they may be sleeping while the surgery is going on. Following
            video shows whole abdomen liposuction being done in an awake
            patient.
            <br /> Once liposuction is complete, navel is separated from the
            attached skin. Navel is NEVER removed. It is only made free from
            skin so that the skin above the navel can be brought down while
            removing excess skin. At a later stage in the surgery, it is brought
            out again and re-sutured to the skin in its normal anatomical
            position.
          </p>
          <div
            style={{
