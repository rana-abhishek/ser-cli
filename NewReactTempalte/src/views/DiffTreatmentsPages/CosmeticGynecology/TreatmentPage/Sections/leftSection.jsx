    ...
    >
      <div>
        <h3 className={props.classes.title}>
          VAGINOPLASTY / VAGINAL TIGHTENING / DESIGNER VAGINA
        </h3>
        <p className={props.classes.darkbrown}>
          Lax vagina can be retightened to remove the laxity which develops due
          to ageing or pregnancies. Vaginal cavity is narrowed to improve
          self-esteem and sex life. The procedure takes about an hour. It is
          performed like a walk-in-walk-out procedure. The anesthesia is
          tumescent local anaesthesia which makes the surgery entirely painless
          and bloodless. There is virtually no bleeding during the entire
          procedure. Vaginoplasty is a very satisfying surgery and gives long
          lasting results.
        </p>
      </div>
          ...
          >
            <Card style={{ margin: "0" }}>
              <Carousel {...props.settings}>
                {props.data.galleryimages.map(item => (
                  <div>
                    <img
                      src={item.src}
                      alt="First slide"
