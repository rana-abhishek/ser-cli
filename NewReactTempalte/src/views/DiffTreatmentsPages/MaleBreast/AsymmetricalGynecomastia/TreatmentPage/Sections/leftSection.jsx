  ...
  return (
    ...
    >
      ...
      {props.data.galleryimages ? (
        <div>
          <h3 className={props.classes.title}>
            Below are some cases of unilateral or asymmetrical Gynecomastia
          </h3>
          <h5 className={props.classes.title}>
            28 yrs. old man: Breast on right side only
          </h5>
          <div
            style={{
              display: "flex",
          ...
          <h5 className={props.classes.title}>
            Operated on Right side only: dense glands removed
          </h5>
          <div
            style={{
              display: "flex",
          ...
          <h5 className={props.classes.title}>
            27 yrs. old man: Breast on right side only
          </h5>
          <div
            style={{
              display: "flex",
          ...
          <h5 className={props.classes.title}>
            26 yrs. old man: Breast on left side only
          </h5>
          <div
            style={{
              display: "flex",
          ...
          <h5 className={props.classes.title}>Operated on left side only</h5>
          <div
            style={{
              display: "flex",
              flexWrap: "wrap",
          ...
          <h5 className={props.classes.title}>24 yrs. old man</h5>
          <div
            style={{
              display: "flex",
              flexWrap: "wrap",
          ...
          <h5 className={props.classes.title}>Operated on right side only</h5>
          <div
            style={{
              display: "flex",
              flexWrap: "wrap",
