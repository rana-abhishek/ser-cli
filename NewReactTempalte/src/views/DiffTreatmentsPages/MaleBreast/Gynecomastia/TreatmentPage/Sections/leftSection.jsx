...
const LeftSection = props => {
  return (
    ...
    >
      ...
      <h3 className={props.classes.title}>Image</h3>
      <div className={props.classes.carimage + " " + props.classes.brownborder}>
        <Card style={{ margin: "0" }}>
          <Carousel {...props.settings}>
            <div>
              <img
                src={props.data.galleryimages[0].src}
                alt="First slide"
                className="slick-image"
              />
              {/* <div className="slick-caption" style={{ paddingBottom: "0px" }}>
                <h4>{props.data.galleryimages[0].imagecaption}</h4>
              </div> */}
            </div>
          </Carousel>
        </Card>
      ...
      {props.data.thirdhead3 ? (
        <div>
          <h3 className={props.classes.title}>
            {props.data.thirdhead3 ? props.data.thirdhead3 : null}
          </h3>
          <p className={props.classes.darkbrown}>
            {props.data.thirddesc3 ? props.data.thirddesc3 : null}
          </p>
          <div
            className={
              props.classes.ticksection + " " + props.classes.darkbrown
          ...
          >
            {props.data.thirdlist3
              ? props.data.thirdlist3.map(item => (
                  <p>
                    <Done className={props.classes.tickicon} />
                    {item.content}
                  </p>
      ...
      {props.data.thirdhead4 ? (
        <div>
          <h3 className={props.classes.title}>
            {props.data.thirdhead4 ? props.data.thirdhead4 : null}
          </h3>
          <p className={props.classes.darkbrown}>
            {props.data.thirddesc4 ? props.data.thirddesc4 : null}
          </p>
          <div
            className={
              props.classes.ticksection + " " + props.classes.darkbrown
          ...
          >
            {props.data.thirdlist4
              ? props.data.thirdlist4.map(item => (
                  <p>
                    <Done className={props.classes.tickicon} />
                    {item.content}
                  </p>
