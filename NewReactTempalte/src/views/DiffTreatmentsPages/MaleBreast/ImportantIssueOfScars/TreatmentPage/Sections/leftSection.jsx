    ...
    >
      ...
      {props.data.galleryimages ? (
        <div>
          ...
          <p className={props.classes.darkbrown}>
            The following examples are being given ONLY TO CONDEMN THEM. These
            are very bad placements of incision which no surgeon should ever
            give in Gynecomastia surgery. It must be remembered that surgery
            lasts only a short time but scars last a lifetime.
          </p>
          <h5 className={props.classes.title}>
            PICTURES OF WRONG INCISIONS & BAD SCARS
          </h5>
          <p className={props.classes.darkbrown}>
            We often see a large number of patients operated elsewhere, who have
            received such ugly scars. These young men came to us for a revision
            of previous surgery, removal of residual gland or fat tissue or
            removal of these scars. Revision surgeries are always difficult
            because previous surgery leaves behind a distorted anatomy, uneven
            tissue and bad scarring inside.
          </p>
          ...
          >
            {props.data.galleryimages.splice(0, 11).map(item => (
              <div>
                {/* <img src={item.src} alt="First slide" className="slick-image" /> */}
                <ModalImage
                  // className={props.classes.brownborder}
