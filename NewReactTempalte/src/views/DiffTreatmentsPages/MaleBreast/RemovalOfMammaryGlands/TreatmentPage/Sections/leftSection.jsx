  ...
  return (
    ...
    >
      ...
      {props.data.galleryimages ? (
        <div>
          <h5 className={props.classes.title}>14 yrs old boy</h5>
          <div
            style={{
              display: "flex",
              flexWrap: "wrap",
          ...
          <h5 className={props.classes.title}>
            27yrs old young man: Very large Gynecomastia
          </h5>
          <div
            style={{
              display: "flex",
          ...
          <h5 className={props.classes.title}>18 yrs. old boy</h5>
          <div
            style={{
              display: "flex",
              flexWrap: "wrap",
          ...
          <h5 className={props.classes.title}>13 yrs. Old boy</h5>
          <div
            style={{
              display: "flex",
              flexWrap: "wrap",
          ...
          <h5 className={props.classes.title}>25 yrs. Old young man</h5>
          <div
            style={{
              display: "flex",
              flexWrap: "wrap",
          ...
          <h5 className={props.classes.title}>15 yrs. Old boy</h5>
          <div
            style={{
              display: "flex",
              flexWrap: "wrap",
          ...
          <h5 className={props.classes.title}>17 yrs. Old boy</h5>
          <div
            style={{
              display: "flex",
              flexWrap: "wrap",
          ...
          <h5 className={props.classes.title}>
            Very dense glands tissue on the inside after cutting the glands
          </h5>
          <div
            style={{
              display: "flex",
          ...
          <h5 className={props.classes.title}>13yrs. old boy</h5>
          <div
            style={{
              display: "flex",
              flexWrap: "wrap",
          ...
          >
            {props.data.galleryimages.splice(0, 6).map(item => (
              <div>
                {/* <img src={item.src} alt="First slide" className="slick-image" /> */}
                <ModalImage
                  // className={props.classes.brownborder}
          ...
          <h5 className={props.classes.title}>22 yrs. old boy</h5>
          <div
            style={{
              display: "flex",
              flexWrap: "wrap",
          ...
          <h5 className={props.classes.title}>19 yrs. old boy</h5>
          <div
            style={{
              display: "flex",
              flexWrap: "wrap",
