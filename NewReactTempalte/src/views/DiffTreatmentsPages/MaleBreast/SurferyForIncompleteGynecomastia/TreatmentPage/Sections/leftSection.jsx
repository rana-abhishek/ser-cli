      ...
      {props.data.galleryimages ? (
        <div>
          <h5 className={props.classes.title}>
            This patient was operated upon two years earlier in another hospital
            in Delhi. On examination it was found that he had mainly residual
            fat on right side and fat and glands on left side. Fat and residual
            glands were removed.
          </h5>
          <div
            style={{
          ...
          >
            {props.data.galleryimages.splice(0, 5).map(item => (
              <div>
          ...
          <h5 className={props.classes.title}>
            This patient came for checkup for the residual breast tissue after a
            surgery that was performed six months earlier. There were two badly
            placed scars, a horizontal one on right side and a long elliptical
            on the left side. There were residual fat and gland on both sides.
            Surgery was done. All residual gland and fat were removed from both
            sides. Revision surgery for the wide scar on right was also done.
          </h5>
          <div
            style={{
              display: "flex",
          ...
          <h5 className={props.classes.title}>
            43 years old man was operated elsewhere and presented with residual
            fat and glands on both sides. He was operated upon and all the
            residual tissues were removed. Good symmetrical results.
          </h5>
          <div
            style={{
              display: "flex",
          ...
          <h5 className={props.classes.title}>
            40 years old man was operated upon in another hospital. Surgery had
            been done through a badly placed long scar. On examination it was
            found that there were large glands still present on both sides along
            with fat. He was operated upon by Tumescent Awake technique, totally
            under local anaesthesia. All the residual glands and fat were
            removed. Pictures below show before and after
          </h5>
          <div
            style={{
              display: "flex",
