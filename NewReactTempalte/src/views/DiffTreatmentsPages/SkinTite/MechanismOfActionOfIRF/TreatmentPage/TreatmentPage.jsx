...
import image1 from "assets/img/TreatmentSections/SkinTite/MechanismOfActionOfIRF/GalleryImages/Image1.jpg";
import image2 from "assets/img/TreatmentSections/SkinTite/MechanismOfActionOfIRF/GalleryImages/Image2.jpg";
import image3 from "assets/img/TreatmentSections/SkinTite/MechanismOfActionOfIRF/GalleryImages/Image3.jpg";

import profilePic from "assets/img/TreatmentSections/SkinTite/MechanismOfActionOfIRF/RightProfileImage.png";
  ...
  render() {
    ...
    const treatdata = {
      main: {
        ...
        head2: "(MECHANISM OF ACTION OF ReformCRF for Skin Tightening)",
        desc: `ROOTActiv is a PRP treatment for Hair growth, scalp
      ...
      left: {
        ...
        // secondhead: "Infra-Red (IR)   Radio Frequency (RF) Skin Tightening",
        // seconddesc: `Modern technology allows us to replace ageing collagen with young and healthy collagen. Regulated energy emitted by modern Radio-frequency machines are capable of bringing about this change. Addition of Infra-red energies to Radio-frequency has proven to be very effective in bringing about this change. Infra-red & Radio-frequency – IRF used at VITAL CLINIC gives very effective and lasting replacement of ageing collagen with young and healthy collagen. During the entire process there is simultaneous cooling of the skin surface so that there is no discomfort to the patient during treatment.

        // IRF combines the best technologies in the world to give non-surgical skin tightening without any side effects and downtime.
        ...
        //   }
        // ]
        sixthhead: `How VITAL Skin-Vital Skin-Tite™ works`,
    ...
    return (
      <div>
        ...
        />
        <Parallax
          image={require("assets/img/TreatmentSections/SkinTite/MechanismOfActionOfIRF/BG.jpg")}
          filter="dark"
