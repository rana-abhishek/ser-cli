    ...
    >
      ...
      {props.data.galleryimages ? (
        <div>
          ...
          <br />
          <p className={props.classes.darkbrown}>
            “very good service and definitely there is difference in
            pigmentation on my face & glow is there”
          </p>
          <div
            style={{
              display: "flex",
          ...
          >
            {props.data.galleryimages.splice(0, 1).map(item => (
              <div className={props.classes.brownborder}>
                {/* <img src={item.src} alt="First slide" className="slick-image" /> */}
                <ModalImage
                  // className={props.classes.brownborder}
                  small={item.src}
          ...
          <br />
          <p className={props.classes.darkbrown}>
            Nisha Gulati shares her experience after undergoing VITAL Skin-tite™
            treatment with ReformCRF & skin treatment has following to say
          </p>
          <p className={props.classes.darkbrown}>
            “After the 1st session, the results don’t get visible just after
            taking session, it takes some days to see the visible changes. The
            jaw lines seems more tighter and prominent than before”
          </p>
          <div
            style={{
              display: "flex",
